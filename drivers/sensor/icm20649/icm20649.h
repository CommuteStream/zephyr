...
#define ICM20649_REG_USER_CTL							0x03
...
#define ICM20649_MASK_PWR_MGMT_2_DISBALE_ACCEL			(BIT(5) | BIT(4) | BIT(3))
#define ICM20649_SHIFT_PWR_MGMT_2_DISABLE_GYRO			0
#define ICM20649_MASK_PWR_MGMT_2_DISBALE_GYRO			(BIT(2) | BIT(1) | BIT(0))
...
#define ICM20649_SHIFT_INT_PIN_CFG_INT1_LATCH_INT_EN	5
#define ICM20649_MASK_INT_PIN_CFG_INT1_LATCH_INT_EN		BIT(5)
...
#define ICM20649_SHIFT_ACCEL_CONFIG_ACCEL_DLPCFG		3
#define ICM20649_MASK_ACCEL_CONFIG_ACCEL_DLPCFG			(BIT(5) | BIT(4) | BIT(3))
...
#define ICM20649_REG_ACCEL_CONFIG2						0x15
...
#if CONFIG_ICM20649_SAMPLE_RATE_DIV == 0
	#define ICM20649_DEFAULT_SAMPLE_RATE_DIV 1
#else
	#define ICM20649_DEFAULT_SAMPLE_RATE_DIV CONFIG_ICM20649_SAMPLE_RATE_DIV
#endif

#define ICM20649_DEFAULT_ACCEL_STANDBY_AVG 4
...
#define ICM20649_DEFAULT_GYRO_STANDBY_AVG 4
#define ICM20649_DEFAULT_GYRO_LPF_CHOICE 0
